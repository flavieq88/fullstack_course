...
describe('favorite blog', () => {
  ...
  test('when list has many blogs, equals the most liked one', () => {
  ...
  test('when list empty, returns empty object', () => {
...
describe('author with most blogs', () => {
  ...
  test('when list has many blogs, equals the author with most blog posts', () => {
    const result = listHelper.mostBlogs(listWithManyBlogs);
    assert.deepStrictEqual(result, { author:'Robert C. Martin', blogs:3 });
  });

  test('when list empty, returns no author and 0 blogs', () => {
